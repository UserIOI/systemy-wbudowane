...
\begin{itemize}
    ...
    \item GPS (Global Positioning System)$ - $ System nawigacji satelitarnej umożliwiający określenie dokładnej pozycji geograficznej na całym świecie.
    \item ULC (Urząd Lotnictwa Cywilnego)$ - $ Polska instytucja odpowiedzialna za nadzór i regulację cywilnego ruchu lotniczego, w tym dronów.
    \item I2C (Inter-Integrated Circuit)$ - $ Protokół komunikacyjny umożliwiający wymianę danych pomiędzy różnymi układami scalonymi za pomocą dwóch linii $ - $ danych (SDA) i zegara (SCL).
    \item SPI (Serial Peripheral Interface)$ - $ Protokół komunikacyjny do szybkiej wymiany danych pomiędzy mikrokontrolerem, a urządzeniami peryferyjnymi za pomocą czterech linii $ - $ danych wejścia (MISO), danych wyjścia (MOSI), zegara (SCK) i sygnału wyboru urządzenia (SS).
    \item GPIO (General Purpose Input/Output)$ - $ Uniwersalne piny na mikrokontrolerze lub komputerze jednopłytkowym, które mogą być konfigurowane jako wejścia lub wyjścia do sterowania różnymi urządzeniami.
    \item MIPI CSI (Mobile Industry Processor Interface Camera Serial Interface)$ - $ Standard interfejsu używany do podłączania kamer do procesorów, umożliwiający przesyłanie danych obrazu z dużą prędkością.
    \item CPU (Central Processing Unit)$ - $ Centralna jednostka przetwarzająca (procesor), odpowiedzialna za wykonywanie instrukcji i zarządzanie operacjami w komputerze lub mikrokontrolerze.
    \item JSS $ - $ jednostka sterująca silnikami
\end{itemize}
...
\begin{enumerate}
    ...
    \item Diody kontrolne $ - $ każde ramię z silnikiem zostanie wyposażone w diodę kontrolną oraz jedną diodę zamieszczoną z tyłu drona. Diody te będą ułatwiały proces kalibracji, a podczas lotu będą zwiększały widoczność BSP. Kontroler również będzie wyposażony w diody. (Diody będą opisane w części działania systemu.)
\end{enumerate}
...
\begin{table}[H]
    ...
    \begin{minipage}[t]{0.6\linewidth}
        \begin{enumerate}
            \item Przesunięcię switcha z pozycji 'off' na pozycje 'on'
            \item Próba sparowania kontrolera z dronem
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU:} Wyciągnięcie karty pamięci SD & \textbf{Numer PU:} 7 & \textbf{Priorytet:} niski \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} ogólny} \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU:} Kalibracja drona & \textbf{Numer PU:} 8 & \textbf{Priorytet:} średni \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} ogólny} \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: }Ładowanie akumulatorów drona  & \textbf{Numer PU:} 9 & \textbf{Priorytet:} średni \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} ogólny} \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: }Ładowanie akumulatorów kontrolera  & \textbf{Numer PU:} 10 & \textbf{Priorytet:} średni \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} ogólny} \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: }Wysyłanie obrazu z kamery na żywo  & \textbf{Numer PU:} 11 & \textbf{Priorytet:} średni \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: } Wykonanie ruchu  & \textbf{Numer PU:} 12 & \textbf{Priorytet:} wysoki \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} szczegółowy} \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: } Lądowanie  & \textbf{Numer PU:} 13 & \textbf{Priorytet:} średni \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} szczegółowy} \\
\hline
\multicolumn{3}{|c|}{\textbf{Udziałowcy i cele:} użytkownik, kontroler, dron}\\
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: } Wysyłanie sygnału PING do drona & \textbf{Numer PU:} 14 & \textbf{Priorytet:} średni \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: } Powrót do miejsca startu  & \textbf{Numer PU:} 15 & \textbf{Priorytet:} średni \\
\hline
\textbf{Aktor podstawowy:} dron & \multicolumn{2}{|c|}{\textbf{Typ opisu:} szczegółowy} \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: } Podłączenie telefonu do kontrolera  & \textbf{Numer PU:} 16 & \textbf{Priorytet:} niski \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} szczegółowy} \\
\hline
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: } Odłączenie telefonu od kontrolera  & \textbf{Numer PU:} 17 & \textbf{Priorytet:} niski \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} szczegółowy} \\
\hline
\multicolumn{3}{|c|}{\textbf{Udziałowcy i cele:} użytkownik, kontroler}\\
...
\begin{tabular}{|p{5cm}|p{5cm}|p{5cm}|}
\hline
\textbf{Nazwa PU: } Wykonanie zdjęcia & \textbf{Numer PU:} 18 & \textbf{Priorytet:} średni \\
\hline
\textbf{Aktor podstawowy:} użytkownik & \multicolumn{2}{|c|}{\textbf{Typ opisu:} szczegółowy} \\
\hline
\multicolumn{3}{|c|}{\textbf{Udziałowcy i cele:} użytkownik, kontroler, dron}\\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.98\textwidth]{../resources/diagram_stanow.drawio_1.pdf}
    \caption[short]{Diagram stanów systemu}
    \label{fig:label}
  \end{figure}

Kiedy system jest włączony użytkownik ma możliwość podłączenia/odłączenia urządzenia mobilnego przy pomocy, którego jest odbierane wideo co prezentuje poniższy diagram:

  \begin{figure}[h]
      \centering
      \includegraphics[width=0.80\textwidth]{../resources/wideo_stany_idk.pdf}
      \caption[short]{Diagram przepływu obrazu}
      \label{fig:label}
    \end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.98\textwidth]{../resources/drzewo_przygotowania_do_lotu.pdf}
    \caption[short]{Drzewo decyzyjne przygotowania do lotu}
    \label{fig:label}
  \end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.80\textwidth]{../resources/przeplyw_sygna_z_kontrolera.pdf}
    \caption[short]{Diagram przepływu sygnału z kontrolera do drona}
    \label{fig:label}
  \end{figure}

  \newpage

\textbf{Sposób poruszania się drona:}
\begin{itemize}
    \item Poruszenie lewego drążka w przód, powoduje: jednostka sterująca silnikami (JSS) zwiększa obroty wszystkich silników co powoduje wznoszenie się drona.
    \item Poruszenie lewego drążka w tył, powoduje: JSS zmniejsza obroty wszystkich silników co powoduje opadanie drona.
    \item Pozostawienie lewego drążka bez ingerencji użytkownika, powoduje: JSS ustawia domyślną prędkość silników co pozwala BSP utrzymywanie wysokości.
    \item Poruszenie prawego drążka w przód, powoduje: JSS zwiększa obroty silników z tyłu oraz lekko przechyla się BSP.
    \item Poruszenie prawego drążka w tył, powoduje: JSS zwiększa obroty silników z przodu oraz lekko przechyla się BSP.
    \item Poruszenie prawego drążka w prawo, powoduje: JSS zwiększa obroty silników z lewej co powoduje poruszanie się BSP w prawo.
    \item Poruszenie prawego drążka w lewo, powoduje: JSS zwiększa obroty silników z prawej co powoduje poruszanie się BSP w prawo.
\end{itemize}

\textbf{Diody kontrolne:}
\begin{itemize}
    \item Kalibracja - Zaświecenie na 3 sekundy na zielono lub czerwono w zależności od odpowiednio powodzenia i niepowodzenia, konkretnego etapu kalibracji
    \item Światła nawigacyjne w trakcie lotu - lewe ramiona na czerwono i prawe ramiona na zielono, oraz białe światło tylne
    \item Niski poziom akumulatorów przy włączeniu drona - diody na ramieniach mrugają na czerwono
    \item Niski poziom akumulatorów w trakcie lotu - zaświecenie diody kontrolnej na kontrolerze na czerwono
    \item Brak połączenia pomiędzy kontrolerem a BSP - mruganie diody kontrolnej kontrolera oraz diod na ramieniach BSP 
\end{itemize}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.94\textwidth]{../resources/diagram_przeplywu_kalibracji.drawio_1.pdf}
    \caption[short]{Diagram przepływu kalibracji}
    \label{fig:label}
  \end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.70\textwidth]{../resources/Diagram_interakcji.drawio.pdf}
    \caption[short]{Diagram interakcji}
    \label{fig:label}
  \end{figure}
% ż
